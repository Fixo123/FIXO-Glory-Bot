...
class Config:
    ...
    # FreeFire API
    FREE_FIRE_API_MODE = os.getenv("FREE_FIRE_API_MODE", "real")
    FREE_FIRE_SECRET_KEY = os.getenv("FREE_FIRE_SECRET_KEY", "your_secret_key_here")

    # Protocol Settings
    PROTOCOL_VERSION = os.getenv("PROTOCOL_VERSION", "1.105.0")
